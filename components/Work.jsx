...
const Work = () => {
  return (
    ...
    <section className=" ">
      <div className="container mx-auto flex flex-col items-center gap-8 md:gap-24">
        <div
          className="max-w-[350px] mx-auto md:mx-0 text-center md:text-left  flex flex-col justify-center items-center"
          data-aos="fade-up"
        >
          <h2 className="section-title mb-4">Latest Project</h2>
        ...
        {/* slider */}
        <div className="max-w-full" data-aos="fade-left" data-aos-delay={100}>
          <Swiper
            className="h-[500px]"
            slidesPerView={1}
            breakpoints={{
